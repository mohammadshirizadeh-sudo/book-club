...
PublisherService::PublisherService(BookService* bookService ,BookRepository* repo , UserRepository* userRepo)
    : bookService(bookService) ,bookRepo(repo) , userRepo(userRepo) {
}
